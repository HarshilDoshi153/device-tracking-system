...
?>
<!DOCTYPE html>
<html lang="en" ng-app="myApp" ng-controller="liveStatusController">
  ...
  <div class="content-wrapper" style="background-color: #f0f0f9">
    <div class="content-header mx-3">
      <div class="container-fluid">
        <div class="row mb-1">
          <h2 style="color: #1f203f" class="p-0">
        ...
        <div class="card round card-default shadow" style="border: 0; background-color: #faf8fc">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-2 col-12">
                <label class="my-1"><b>Status</b></label>
                <select name="statuses" ng-model="sta" ng-change="loadData()"class="form-control select2bs4" style="width: 100%">
                  <option value="">Please Select</option>
                  <option ng-repeat="d in data | limitTo:1" value="Active">
                    Active</option>
                  <option ng-repeat="d in data | limitTo:1" value="Inactive">
                    Inactive</option>
                </select>
              </div>
            </div>
              ...
              <table id="example2" border="1" class="table table-bordered text-nowrap" style="top: 0; width: 100%">
                ...
                <tbody class="card-body">
                  <tr ng-repeat="d in data | filter: {district: Did, block: Bid, village: Vid, school: Sid}">
                    ...
                    <td class="text-center">{{d.village}}</td>
                    <td class="text-center">{{d.school}}</td>
                    <td class="text-center">{{d.serial_number}}</td>
                    <td class="text-center">
                      <span ng-show="d.Status == 'Active'" class="badge rounded-pill p-1 bg-success">{{d.Status}}</span>
                      <span ng-show="d.Status == 'Inactive'"
                        class="badge rounded-pill p-1 bg-danger">{{d.Status}}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
