...
?>
<!DOCTYPE html>
<html lang="en" ng-app="myApp" ng-controller="schoolController">
  ...
  <div class="content-wrapper" style="background-color: #f0f0f9;">
    <div class="content-header mx-3">
      <div class="container-fluid">
        <div class="row mb-1">
          <h2 style="color: #1f203f;" class="p-0"><b>Schools</b></h2>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12 my-1">
        <div class="card round shadow" style="border: 0;">
          ...
          <div class="card-body  p-3">
            <div class="  p-0 table-responsive"></div>
            <table id="example2" border="1" class="table table-bordered text-nowrap" style="top:0; width:100%;">
              ...
              <tbody class="card-body">
                <tr
                  ng-repeat="d in data | filter: {district: Did, block: Bid, village: Vid, school: Sid, dise_code: dise}">
