...
?>
<!DOCTYPE html>
<html lang="en" ng-app="myApp" ng-controller="regInfoController">
  ...
  <div class="content-wrapper" style="background-color: #f0f0f9;">
    <div class="content-header mx-3">
      <div class="container-fluid">
        <div class="row mb-1">
          <h2 style="color: #1f203f;" class="p-0"><b>Registration Info</b></h2>
        </div>
      </div>
    </div>
    <!-- <div class="content"> -->
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-2 col-12">
                ...
                <select name="Schools" ng-model="Sid" class="form-control" style="width: 100%">
                  <option value>Please Select</option>
                ...
                <form action="mailForm.php" method="post">
                  <div class="form-group">
                    <button id="action" type="submit" class="btn bg rounded-1 btn-clr btn-md w-100"
                      style="margin-top: 0px; border-radius:10px" name="send">
                      <i class="cib-gmail"></i><br>Send Email</button>
                  </div>
                </form>
              </div>
              <div class="col-lg-2 col-12">
                <label class="my-1"><b>Dise Code</b></label>
                <input type="text" class="form-control" ng-model="dise" placeholder = "Please Type">
              </div>
              <div class="col-lg-2 col-12">
                <label class="my-1"><b>From Date</b></label>
                <input type="date" ng-model="fromDate" style="border: 1px solid #ced4da;border-radius: 4px;"
                  class="form-control">
              </div>
              <div class="col-lg-2 col-12">
                <label class="my-1"><b>To Date</b></label>
                <input type="date" ng-model="toDate" style="border: 1px solid #ced4da;border-radius: 4px;"
                  class="form-control">
              </div>
              <div class="col-lg-1 col-12">
                  <div class="form-group">
                    <button id="action" type="submit" class="btn bg rounded-1 btn-clr btn-md w-100" ng-model="clear" ng-click="Clear()"
                      style="margin-top: 30px; border-radius:10px" name="clear">Clear</button>
                  </div>
              </div>
            </div>
          </div>
              ...
              <div ng-init="loadData()">
                <table id="example2" border="1" class="table table-bordered text-nowrap" style="top:0; width:100%;">
                  ...
                  <tbody class="card-body">
                    <tr ng-show="toDate == null"
                      ng-repeat="da in Alldata | filter: {district: Did, block: Bid, village: Vid, school: Sid, dise_code: dise} ">
                      <td class="text-center">{{$index + 1}}</td>
                      <td class="text-center">{{da.dise_code}}</td>
                      <td class="text-center">{{da.school}}</td>
                      <td class="text-center">{{da.district}}</td>
                      <td class="text-center">{{da.lab}}</td>
                      <td class="text-center">{{da.comp_number}}</td>
                      <td class="text-center">{{da.serial_number}}</td>
                      <td class="text-center">{{da.TFT_serial}}</td>
                      <td class="text-center">{{da.WEB_serial}}</td>
                      <td class="text-center">{{da.Head_serial}}</td>
                      <td class="text-center">{{da.Switch_serial}}</td>
                      <td class="text-center">{{da.regDate}}</td>
                    </tr>
                    <tr ng-show="toDate != null"
                      ng-repeat="d in data | filter: {district: Did, block: Bid, village: Vid, school: Sid, dise_code: dise} | dateRange:fromDate:toDate">
                      <td class="text-center">{{$index + 1}}</td>
                      ...
                      <td class="text-center">{{d.regDate}}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
