...
?>
<!DOCTYPE html>
<html lang="en" ng-app="myApp" ng-controller="activityController">
  ...
  <div class="content-wrapper" style="background-color: #f0f0f9;">
    <div class="content-header mx-3">
      <div class="container-fluid">
        <div class="row mb-1">
          <h2 style="color: #1f203f;" class="p-0"><b>Application On-Off Timing</b></h2>
        </div>
      </div>
    </div>
    <!-- <div class="content"> -->
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-2 col-12">
                ...
                <select name="Schools" ng-model="Sid" class="form-control" ng-change="loadSerials()"style="width: 100%">
                  <option value="">Please Select</option>
                ...
                <table id="example2" border="1" class="table table-bordered text-nowrap" style="top:0; width:100%;">
                  ...
                  <tbody class="card-body">
                    <tr ng-repeat="d in data">
                      ...
                      <td class="text-center">{{d.package_name}}</td>
                      <td class="text-center">{{d.date}}</td>
                      <td class="text-center">{{d.start_time}}</td>
                      <td class="text-center">
                        <span ng-show="d.end_time==''" class="badge bg-success">Running</span>
