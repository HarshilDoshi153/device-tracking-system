...
?>
<!DOCTYPE html>
<html lang="en" ng-app="myApp" ng-controller="deviceController">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="content-wrapper" style="background-color: #f0f0f9;">
    <div class="content-header mx-3">
      <div class="container-fluid">
        <div class="row mb-1">
          <h2 style="color: #1f203f;" class="p-0"><b>Device On-Off Timing</b></h2>
        </div>
      </div>
    </div>
    <!-- <div class="content"> -->
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-2 col-12">
                ...
                <select name="Schools" ng-model="Sid" class="form-control" ng-change="loadSerials()"
                  style="width: 100%">
                  <option value="">Please Select</option>
              ...
              <div class="col-lg-2 col-12">
                ...
                <select ng-model="serial" class="form-control" ng-change="loadData(serial)" style="width: 100%">
                  <option value="">Please Select</option>
                  <option ng-repeat="s in Serials" value="{{s.serial_number}}">
                    {{s.serial_number}}</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div class="card shadow round" style="border: 0;">
          ...
          <div class="card-body p-3">
            <div class="p-0 table-responsive">
              <table id="example2" class="table table-bordered text-nowrap" border="1" style="top:0; width:100%;">
                <thead class="fixed-header" style="color: #1f203f;">
                  <tr>
                    ...
                    <th class="text-center">Off Time</th>
                ...
                <tbody class="card-body">
                  <tr ng-repeat="d in data">
                    ...
                    <td class="text-center">
                      <span ng-show="d.duration == '00:05:00'" class="badge bg-success">Running</span>
                      <span ng-show="d.duration != '00:05:00'">{{d.end_time}}</span>
                    </td>
  ...
  <footer class="main-footer" style="color: #1f203f;">
    ...
    <a href="https://cienciasvr.com/" target="_blank">Ciencias IN VR Provate Limited</a>.
    All rights reserved.
